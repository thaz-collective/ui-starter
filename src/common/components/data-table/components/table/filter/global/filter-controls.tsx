import type { DataTableColumnMeta } from '#src/common/components/data-table/lib/dynamic-filter/filter-util';
import {
  DEFAULT_NUMBER_FILTER_OPERATOR_OPTION_LIST,
  FilterNumberOperator,
  FilterNumberValue,
} from '#src/common/components/data-table/components/table/filter/number';
import {
  DEFAULT_STRING_FILTER_OPERATOR_OPTION_LIST,
  FilterStringOperator,
  FilterStringValue,
} from '#src/common/components/data-table/components/table/filter/string';
