          ...
          <>
            <div
              className={cn(
                ...
                'group-[&[data-selected],&[data-indeterminate]]/checkbox-button:bg-primary',
                'group-[&[data-selected],&[data-indeterminate]]/checkbox-button:text-primary-foreground',
                'group-[&[data-selected],&[data-indeterminate]]/checkbox-button:group-data-hovered/checkbox-button:bg-primary-hover',
                'group-[&[data-selected],&[data-indeterminate]]/checkbox-button:group-data-pressed/checkbox-button:brightness-95',

                // invalid — wins over primary for border, hover, and focus ring
                'group-data-invalid/checkbox-button:border-danger',
                'group-data-invalid/checkbox-button:group-data-hovered/checkbox-button:border-danger-hover',
                'group-data-invalid/checkbox-button:group-data-focus-visible/checkbox-button:ring-danger',

                'group-data-invalid/checkbox-button:group-[&[data-selected],&[data-indeterminate]]/checkbox-button:bg-danger',
                'group-data-invalid/checkbox-button:group-[&[data-selected],&[data-indeterminate]]/checkbox-button:text-danger-foreground',
                'group-data-invalid/checkbox-button:group-[&[data-selected],&[data-indeterminate]]/checkbox-button:group-data-hovered/checkbox-button:bg-danger-hover',
              )}
            >
